...
public class RegistroController {
    ...
    public String crearUser(Model model, User usuario) 
            throws MessagingException {
        model = registroService.crearUser(model, usuario);
    ...
    @PostMapping("/recordarUser")
    public String recordarUser(Model model, User usuario) 
            throws MessagingException {
        model = registroService.recordarUser(model, usuario);
        return "/registro/salida";
    }
}